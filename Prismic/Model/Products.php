 ...
 */
class Products implements ModelInterface
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'image_url' => 'string',
        'blob' => '\Prismic\Model\ProductsBlob'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blob'] = $data['blob'] ?? null;
    }
     ...
     * Gets blob
     *
     * @return \Prismic\Model\ProductsBlob|null
     */
     ...
     * Sets blob
     *
     * @param \Prismic\Model\ProductsBlob|null $blob blob
     *
     * @return self
     */
